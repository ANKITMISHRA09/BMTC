...
import java.io.*;
	...
	public class Graph_B 
	{
		...
		public void removeEdge(String vname1, String vname2) 
		{
			...
			//checks if the vertices given or the edge between these vertices exist or not
		...
		{
			System.out.println("\t BANGALORE BMTC MAP");
			System.out.println("\t------------------");
			System.out.println("----------------------------------------------------\n");
			ArrayList<String> keys = new ArrayList<>(vtces.keySet());
		...
		public int dijkstra(String src, String des, boolean nan) 
		{
			...
			//removed the pairs while heap is not empty
			...
			while (!heap.isEmpty()) 
			{
				...
				for (String nbr : v.nbrs.keySet()) 
				{
					if (map.containsKey(nbr)) 
					{
						...
						int nc;
						if(nan)
							nc = rp.cost + 120 + 10*k.nbrs.get(nbr);
						else
		...
		public String Get_Min_Distance(String src, String dst) 
		{
		...
		public static void Create_BMTC_Map(Graph_B g)
		{
			g.addVertex("Jayanagar 4th Block");
			g.addVertex("Yeshwanthpur");
			g.addVertex("J P Nagar 6");
			g.addVertex("Chowdeshwari Stand ");
			g.addVertex("Subramanyapura");
			g.addVertex("Majestic");
			g.addVertex("Lalbagh");
			g.addVertex("J P Nagar 1");
			g.addVertex("Ilyas Nagar");
			g.addVertex("South End Circle");
			g.addVertex("K.R. Market");
			g.addVertex("Kaveri Bhavan");
			g.addVertex("KIMS");
			g.addVertex("Yelahanka");
			g.addVertex("Attiguppe");
			g.addVertex("KIA ");
			g.addVertex("BANSHANKRI");
			g.addVertex("KS LAYOUT");
			g.addVertex("BIT");
			g.addVertex("RVCE");
			
			g.addEdge("Jayanagar 4th Block", "Yeshwanthpur", 8);
			g.addEdge("Yeshwanthpur", "J P Nagar 6", 10);
			g.addEdge("J P Nagar 6th Phase", "Chowdeshwari Stand", 8);
			g.addEdge("Chowdeshwari Stand", "Subramanyapura", 6);
			g.addEdge("Subramanyapura", "Majestic", 9);
			g.addEdge("Majestic", "Lalbagh", 7);
			g.addEdge("Lalbagh", "J P Nagar 1", 6);
			g.addEdge("J P Nagar 1", "Ilyas Nagar", 15);
			g.addEdge("Ilyas Nagar", "KIMS", 6);
			g.addEdge("KIMS", "Chowdeshwari Stand", 7);
			g.addEdge("Chowdeshwari Stand", "Kaveri Bhavan", 1);
			g.addEdge("Kaveri Bhavan", "K.R. Market", 2);
			g.addEdge("K.R. Market", "South End Circle", 5);
			g.addEdge("Kaveri Bhavan", "Yelahanka", 2);
			g.addEdge("Yelahank", "Attiguppe", 7);
			g.addEdge("Attiguppe", "KIA", 8);
			g.addEdge("Lalbagh", "KS LAYOUT", 2);
			g.addEdge("RVCE", "BIT", 2);
			g.addEdge("RVCE", "KS LAYOUT", 3);
		}
		...
		public static void main(String[] args) throws IOException
		{
			...
			System.out.println("\n\t\t\t****WELCOME TO THE BMTC APP*****");

			// System.out.println("\t\t\t\t~~LIST OF ACTIONS~~\n\n");
			// System.out.println("1. LIST ALL THE STAND IN THE MAP");
			// System.out.println("2. SHOW THE BMTC MAP");
			// System.out.println("3. GET SHORTEST DISTANCE FROM A 'SOURCE' STAND TO 'DESTINATION' STAND");
			// System.out.println("4. GET SHORTEST TIME TO REACH FROM A 'SOURCE' STAND TO 'DESTINATION' STAND");
			// System.out.println("5. GET SHORTEST PATH (DISTANCE WISE) TO REACH FROM A 'SOURCE' STAND TO 'DESTINATION' STAND");
			// System.out.println("6. GET SHORTEST PATH (TIME WISE) TO REACH FROM A 'SOURCE' STAND TO 'DESTINATION' STAND");
			...
			{
				System.out.println("\t\t\t\t~~LIST OF ACTIONS~~\n\n");
				System.out.println("1. LIST ALL THE STANDS IN THE MAP");
				System.out.println("2. SHOW THE BMTC MAP");
				System.out.println("3. GET SHORTEST DISTANCE FROM A 'SOURCE' STATION TO 'DESTINATION' STAND");
				System.out.println("4. GET SHORTEST TIME TO REACH FROM A 'SOURCE' STAND TO 'DESTINATION' STAND");
				System.out.println("5. GET SHORTEST PATH (DISTANCE WISE) TO REACH FROM A 'SOURCE' STAND TO 'DESTINATION' STAND");
				System.out.println("6. GET SHORTEST PATH (TIME WISE) TO REACH FROM A 'SOURCE' STAND TO 'DESTINATION' STAND");
				...
				case 3:
					...
					System.out.println("\n1. TO ENTER SERIAL NO. OF STAND\n2. TO ENTER CODE OF STAND\n3. TO ENTER NAME OF STAND\n");
					System.out.println("ENTER YOUR CHOICE:");
				        int ch = Integer.parseInt(inp.readLine());
					int j;
						
					String st1 = "", st2 = "";
					System.out.println("ENTER THE SOURCE AND DESTINATION STAND");
					if (ch == 1)
					{
				...
				case 4:
					System.out.print("ENTER THE SOURCE STAND: ");
					String sat1 = inp.readLine();
					System.out.print("ENTER THE DESTINATION STAND: ");
				...
				case 5:
					...
					else 
					{
						...
						int len = str.size();
						System.out.println("SOURCE STAND : " + s1);
						System.out.println("SOURCE STAND: " + s2);
				...
				case 6:
					...
					else
					{
						...
						int len = str.size();
						System.out.println("SOURCE STAND : " + ss1);
						System.out.println("DESTINATION STAND : " + ss2);
